                ...
                for r in range(num_rows):
                    ...
                    if signal:
                        ...
                        if beam['bound_ind_left'][r]:
                            ...
                            col = np.where(np.isin(reduced_2d_grid[r, :], bound_ind))[0]  # col = np.where((reduced_2d_grid[r, :] >= min(bound_ind)) & (reduced_2d_grid[r, :] <= max(bound_ind)))[0]
        ...
        for a, arc in enumerate(arcs):
            for b, beam in enumerate(arc['vmat_opt']):
                ...
                for r in range(num_rows):
                    ...
                    count = count + 1
                    beam['beam_area_in_beamlet'] += beam['cont_leaf_pos_in_beamlet'][r, 1] - beam['cont_leaf_pos_in_beamlet'][r, 0]
